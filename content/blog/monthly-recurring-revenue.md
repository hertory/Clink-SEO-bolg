...
MRR, [ARR](/blog/annual-recurring-revenue), and total revenue answer different questions about the same subscription engine, and teams that blur them produce misleading decks. MRR is the monthly view used for operations; ARR is the annualized view used for forecasting and valuation; total revenue includes everything, recurring or not.
