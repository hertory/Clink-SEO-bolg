...
category: "Product"
author: "Clink Team"
image: /blog/images/what-is-clink.jpg
readingMinutes: 12
---
...
**Clink for Claw** lets agents on the OpenClaw runtime initiate payments inside [pre-set spending limits](/blog/ai-agent-spending-limits) and merchant-type rules. It is **Early Access** as of June 2026—not a GA claim—and is the thesis piece for agent-native commerce. The protocol and market argument are expanded in [AI agents need payments too](/blog/agent-payments).
