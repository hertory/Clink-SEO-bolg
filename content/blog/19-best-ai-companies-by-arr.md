...
| Rank | Company | Est. run rate (annualized) | Valuation (est.) | Notes |
|:---:|---------|---------------------------:|-----------------:|-------|
| 1 | Anthropic | ~$47B | ~$965B | Gross end-customer spend via cloud resellers; highest absolute run rate in category |
| 2 | OpenAI | ~$24–33B | ~$852B | Closer to net; range reflects tracker disagreement |
| 3 | Databricks | ~$5.4B | ~$134B | Data + AI platform; strong enterprise contract base |
| 4 | Cursor | ~$2B+ | ~$50B | AI-native IDE; rapid subscription scale |
| 5 | xAI | ~$1B+ | — | Consumer + API; private estimates |
| 6 | Scale AI | ~$1B+ | — | Data labeling + AI infrastructure services |
| 7 | GitHub Copilot | ~$0.9–1.1B | — | Corrected down from earlier ~$2B headlines; seat-based subscription |
| 8 | Mistral | ~$600M+ | — | European foundation lab; enterprise + API |
| 9 | Midjourney | ~$300–500M | — | Bootstrapped; consumer subscription |
| 10 | ElevenLabs | ~$500M | — | Voice AI; subscription + API |
...
| Your question | Best source type | Why |
|---------------|------------------|-----|
...
| **Investor memo: "How does our run rate compare to AI peers?"** | ARR Club or Sacra company profiles + your audited MRR × 12 | Peer estimates with methodology notes; compare net-to-net where possible |
...
### Which AI company has the highest ARR in 2026?

Anthropic holds the highest estimated absolute revenue run rate among AI-focused companies as of August 2026, at roughly **$47 billion** annualized, according to the AI Business leaderboard. That figure reflects gross end-customer spend through cloud resellers and direct channels, not net revenue identical to SaaS ARR. OpenAI ranks second at an estimated **$24–33 billion**, with methodology closer to net retention by most trackers.

### What is the difference between AI revenue run rate and ARR?

**Run rate** annualizes the most recent month's revenue (monthly revenue × 12) as a forward-looking snapshot. **ARR** in SaaS typically means contracted, recurring subscription revenue normalized to a year, adjusted for expansion, contraction, and churn. AI leaderboard "ARR" often blends API usage, seat subscriptions, and gross marketplace spend—broader and less standardized than operational ARR from a billing system.

### Why do Anthropic and OpenAI dominate the AI revenue ranking?

Together they account for roughly **86%** of the combined top-10 run rate because frontier models monetize at platform scale through API tokens, enterprise deals, and cloud marketplace volume. Their revenue bases are an order of magnitude larger than application-layer AI products in the same list. Dominance reflects current spend concentration, not a permanent cap on other categories.

### Are AI revenue leaderboard numbers audited or exact?

No. Nearly all figures for private AI companies are **estimates** from trackers such as AI Business, ARR Club, Sacra, and Report AI Index. They can revise materially—GitHub Copilot was corrected from ~$2B headlines to roughly **$0.9–1.1B** once seat economics were re-modeled. Treat ranks as directional and bands as honest uncertainty.
...
It depends on the decision. **AI Business** for absolute top-N leaderboards; **ARR Club** or **Sacra** for company profiles and estimate bands; **Report AI Index** for macro trends over time. For operational ARR you will report to investors, your subscription billing data—not any external leaderboard—is the authoritative source.
